            ...
            <div className="space-y-6">
              ...
              >
                <h4 className="text-xl font-semibold text-[#00fff2]">
                  Software Development Intern – TechCorp Solutions
                </h4>
                <p className="text-gray-400 text-sm mb-2">Jun 2024 – Aug 2024</p>
                <ul className="list-disc pl-5 text-gray-300 text-sm space-y-1">
                  <li>Developed full-stack web apps with React & Node.js</li>
                  <li>Improved UI performance & implemented new features</li>
                  <li>Built and optimized RESTful API endpoints</li>
                </ul>
              </motion.div>
