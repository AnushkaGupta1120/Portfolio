...
{showPopup && (
  <motion.div
    ...
    className="fixed bottom-10 right-10 bg-gradient-to-r from-[var(--teal-1)] to-[var(--teal-2)] text-black font-semibold px-6 py-3 rounded-xl shadow-lg backdrop-blur-md z-50"
  >
