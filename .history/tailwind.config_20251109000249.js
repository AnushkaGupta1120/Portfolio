...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: ["Raleway", "Poppins", "Inter", "sans-serif"], // Added Raleway
      },
      colors: {
        // 🟦 Primary brand palette (from your reference)
        navy: "#1B1F3B", // Deep navy background
        indigoCard: "#2A2E57", // Card / container
        mutedIndigo: "#464D86", // Gradient mid-tone
        accent: "#F4A261", // Orange accent / button color
        light: "#FFFFFF", // White text
        softText: "#C7C9D3", // Muted text tone
        // 🟪 Keep your existing primary/secondary colors
        primary: "#2563eb",
        secondary: "#7c3aed",
      },
      boxShadow: {
        ...
        // Soft glowing accent shadows
        glow: "0 0 25px rgba(244, 162, 97, 0.45)",
        "indigo-glow": "0 0 25px rgba(70, 77, 134, 0.4)",
      },
      backgroundImage: {
        // Optional gradients for Hero/Sections
        "navy-gradient": "linear-gradient(135deg, #1B1F3B, #2A2E57, #464D86)",
        "accent-gradient": "linear-gradient(135deg, #F4A261, #F28C6A)",
      },
      animation: {
