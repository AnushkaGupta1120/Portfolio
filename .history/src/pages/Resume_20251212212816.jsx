        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-2">2022 – 2026</p>
              <p className="text-gray-300">
                Specialization: Computer Science | Achievements: 8.64 CGPA,  
                Healthcare projects, Japanese Certified.
              </p>
            </motion.div>
            ...
            >
              ...
              <ul className="list-disc pl-5 text-gray-300 text-sm space-y-1 mt-2">
                ...
                <li>Adobe UI/UX Design</li>
                <li>Figma Complete Bootcamp</li>
              </ul>
            </motion.div>
          </motion.div>
