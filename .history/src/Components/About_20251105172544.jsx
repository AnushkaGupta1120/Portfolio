          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center animate-fadeInLeft animation-delay-300">
              <div className="relative w-72 h-72">
                ...
                <img 
                  src="/profile.jpg" 
                  alt="Anushka Gupta"
                  className="absolute inset-0 w-full h-full object-cover rounded-lg transform -rotate-3 transition-transform hover:rotate-0 duration-300 shadow-xl"
                />
              </div>
            </div>
            ...
            <div className="space-y-6 animate-fadeInRight animation-delay-300">
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed animate-slideInUp animation-delay-400">
                I am a passionate final-year B.Tech student specializing in Computer Science Engineering (Specialisation in Gaming Technology) with a strong foundation in Software and Full-Stack development. My journey in technology began with curiosity about how applications work behind the scenes, which led me to explore both frontend and backend development.
              </p>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed animate-slideInUp animation-delay-600">
                When I'm not coding, I enjoy learning new technologies, participating in hackathons, and staying updated with tech trends. I believe in continuous learning and pushing my limits.
              </p>
