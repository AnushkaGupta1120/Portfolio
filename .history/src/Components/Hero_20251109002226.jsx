...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex flex-col justify-center items-center text-center bg-[#0b0c10] text-gray-100 overflow-hidden"
    >
      {/* Decorative circles */}
      ...
      >
        <h1 className="text-5xl md:text-6xl font-bold mb-4 leading-tight">
          Hi, I’m <span className="text-[#f4a261]">Anushka Gupta</span>
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <a
            href="#contact"
            className="px-8 py-3 rounded-full font-semibold border border-[#f4a261] text-[#f4a261] hover:bg-[#f4a261]/10 transition-all duration-300"
          >
            Contact Me
          </a>
        </div>
