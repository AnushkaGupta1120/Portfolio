      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-8 animate-fadeInLeft">
          ...
          <div className="flex gap-4 pt-4">
            <a href="#" className="p-3 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-blue-600 text-gray-800 dark:text-white hover:text-white transform hover:scale-110"><FiGithub className="w-6 h-6"/></a>
            <a href="#" className="p-3 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-blue-600 text-gray-800 dark:text-white hover:text-white transform hover:scale-110"><FiLinkedin className="w-6 h-6"/></a>
            <a href="#" className="p-3 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-blue-600 text-gray-800 dark:text-white hover:text-white transform hover:scale-110"><FiMail className="w-6 h-6"/></a>
          </div>
