...
const projectsData = [
  ...
  },
  {
    ...
    description: 'Comprehensive job application tracking with status updates, interview scheduling, and analytics dashboard.',
    tech: ['React', 'Node.js', 'MySQL', 'JWT', 'Chart.js'],
    category: 'fullstack',
  },
  {
    title: 'Weather App',
