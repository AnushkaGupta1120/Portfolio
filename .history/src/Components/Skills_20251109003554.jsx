      ...
      <div className="max-w-6xl mx-auto relative z-10 text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 justify-center">
          {skills.map((skill, index) => (
            <div
              key={index}
              className={`group relative flex flex-col items-center justify-center p-10 rounded-2xl bg-[#14161a] border border-[#f4a261]/10 transition-all duration-500 hover:-translate-y-2 hover:border-[#f4a261]/50 shadow-[0_0_25px_rgba(244,162,97,0.08)]
