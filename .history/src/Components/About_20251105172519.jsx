          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 animate-fadeInRight animation-delay-300">
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed animate-slideInUp animation-delay-400">
                I am a passionate final-year B.Tech student specializing in Computer Science Engineering (Specialisation in Gaming Technology) with a strong foundation in full-stack development. My journey in technology began with curiosity about how applications work behind the scenes, which led me to explore both frontend and backend development.
              </p>
