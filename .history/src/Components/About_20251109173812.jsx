...
export default function About() {
  ...
  const stats = [
    { label: "4+", desc: "Projects" },
    { label: "2", desc: "Internships" },
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <motion.a
  href="public/resume.pdf" // <-- Path to your resume
  download="Anushka_Gupta_Resume.pdf"
  whileHover={{ scale: 1.05, y: -3 }}
  whileTap={{ scale: 0.95 }}
  className="inline-block px-8 py-3 bg-gradient-to-r from-[#f4a261] to-[#F28C6A] text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
>
  📥 Download Resume
</motion.a>
