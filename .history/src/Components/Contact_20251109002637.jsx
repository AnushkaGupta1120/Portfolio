      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <motion.div
            ...
            initial="hidden"
            whileInView="show"
            className="bg-[#14161a] border border-[#f4a261]/20 rounded-2xl p-8 shadow-[0_0_40px_rgba(244,162,97,0.05)]"
          >
              ...
              {[
                ...
                return (
                  <a
                    ...
                    className="flex items-center gap-4 p-4 rounded-lg bg-[#0b0c10] hover:bg-[#f4a261]/10 transition-all duration-300 group border border-[#f4a261]/10 hover:border-[#f4a261]/40"
                  >
                    ...
                    <div>
                      ...
                      <p className="text-gray-100 font-semibold group-hover:text-[#f4a261] transition-colors duration-300">
                        {item.value}
                      </p>
                    </div>
                  </a>
          ...
          <motion.form
            ...
            className="bg-[#14161a] border border-[#f4a261]/20 rounded-2xl p-8 shadow-[0_0_40px_rgba(244,162,97,0.05)] space-y-6"
          >
            <h3 className="text-2xl font-semibold text-[#f4a261] mb-6">
              Send a Message
            </h3>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg bg-[#0b0c10] text-gray-200 border border-[#f4a261]/20 focus:border-[#f4a261]/60 outline-none transition-all duration-300"
              required
            />
            <input
              type="email"
            ...
            <textarea
              ...
              rows="5"
              className="w-full px-4 py-3 rounded-lg bg-[#0b0c10] text-gray-200 border border-[#f4a261]/20 focus:border-[#f4a261]/60 outline-none resize-none transition-all duration-300"
              required
            ></textarea>

            <button
              type="submit"
              className="w-full py-3 rounded-full bg-[#f4a261] text-[#0b0c10] font-semibold hover:bg-[#ffb87a] transition-all duration-300 shadow-lg shadow-[#f4a261]/30"
            >
              Send Message ✉️
            </button>
          </motion.form>
