          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 animate-fadeInRight animation-delay-300">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed animate-slideInUp animation-delay-600">
                When I'm not coding, I enjoy contributing to open-source projects, participating in hackathons, and staying updated with the latest tech trends. I believe in continuous learning and am always eager to take on new challenges that push my boundaries.
              </p>
