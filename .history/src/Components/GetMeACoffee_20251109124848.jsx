...
export default function GetMeACoffee() {
  ...
  const handleCoffeeClick = () => {
    ...
    // Add your payment/donation link here
  ...
  return (
    <section
      id="coffee"
      className="relative py-20 bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100 dark:from-[#1B1F3B] dark:via-[#2A2E57] dark:to-[#0b0c10] transition-colors duration-500 overflow-hidden"
    >
      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        >
          If you enjoyed my work or found it helpful, consider supporting me with a coffee! 
        ...
        <motion.button
          ...
          whileHover={{ 
            scale: 1.1,
            boxShadow: "0 0 40px rgba(244, 162, 97, 0.6)",
          }}
          whileTap={{ scale: 0.95 }}
          className="relative px-10 py-4 bg-gradient-to-r from-amber-500 to-orange-500 dark:from-[#f4a261] dark:to-[#F28C6A] text-white font-bold text-xl rounded-full shadow-2xl hover:shadow-glow transition-all duration-300 flex items-center gap-3 mx-auto"
        >
        ...
        >
          <p className="text-gray-700 dark:text-gray-300 text-lg">
            ...
            Every coffee helps me create better content and improve my skills.
          </p>
        </motion.div>
      </div>
    </section>
